...
#'
#' @description Predict single-year, age-specific probabilities of dying (1qx) using the SVD-Comp mortality model indexed by child/child-adult mortality.
#' @author Samuel J. Clark, \email{work@samclark.net}
#' @references \doi{doi:10.48550/arXiv.1612.01408} and \doi{doi:10.1007/s13524-019-00785-3}
...
predictLT <- function(sex,cm,smooth=TRUE,outlogit=FALSE,out5=TRUE,am=NULL,modsv=2018) {
  ...
  # modsv: model version is either 2018, 2022, or 2024 defaults to 2018
