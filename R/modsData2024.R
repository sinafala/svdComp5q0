...
#'
#' @description An R object containing a hierarchy of lists that contain SVD-derived components,
...
#'     reduces their size. This is the 2024 version of the models that includes
...
#'     }
#' }
#' @source See model development in \doi{doi:10.48550/arXiv.1612.01408} and \doi{doi:10.1007/s13524-019-00785-3}
"mods2024"
